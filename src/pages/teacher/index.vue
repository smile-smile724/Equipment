<template>
  ...
  <div id="mainbox">
    <div id="leftBox">
      ...
      <span id="leftTop">
        最新消息通知
        <router-link to="/InfoEdit/NewsNotice">
          <img src="../../assets/edit.png" style="height:50px;display:inline-block;position:absolute;transform:rotate(90deg);">
        </router-link>
      </span>
      <ul>
        <li >
    ...
    <el-dialog title="最新通知" :visible.sync="NewsFlag" width="70%">
      <div id="newsbox">
        ...
        <span v-show="News[NewsIndex].noticeVideo!=''&&News[NewsIndex].noticeVideo!=null"><a :href="$host+News[NewsIndex].noticeVideo" target="_blank"  style="color:rgb(190, 190, 190);">视频链接</a> </span>
        <span v-show="News[NewsIndex].noticeUrl!=''&&News[NewsIndex].noticeUrl!=null"><a :href="News[NewsIndex].noticeUrl" target="_blank"  style="color:rgb(190, 190, 190);">链接</a> </span>
